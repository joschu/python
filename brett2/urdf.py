# originally by David Lu, WUSTL
# http://code.google.com/p/wu-robotics/source/browse/trunk/urdf_tools/urdf_python/src/urdf_python/urdf.py
    ...
    def parse(node):
        ...
        for child in children(node):
            if child.localName == 'parent':
                ...
                joint.axis = map(float,child.getAttribute('xyz').split())
            elif child.localName == 'origin':
