...
colmin, rowmin = xy_tl
colmax, rowmax = xy_br
z_rectangle = xyz_tf[rowmin:rowmax, colmin:colmax, 2] # z values in extracted rectnalge
...
row_needle += rowmin
cv2.circle(rgb_plot, (col_needle, row_needle), 3, (255,0,0), 2)
