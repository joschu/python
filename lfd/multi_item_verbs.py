...
class VerbStageInfo:
    def __init__(self, stage_name, item, arms_used, special_point):
...
def get_closest_demo_verb_info_by_stage(verb, scene_info, stage_num):
    ...
    closest_verb_name_info = verb_infos[0]
    verb_info = closest_verb_name_info[1] #get the verb info out of the pair
    special_point = None if verb_info["special_pts"][stage_num] == "None" else verb_info["special_pts"][stage_num]
